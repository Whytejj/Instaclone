...
public class UserListActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null){
            ...
            try {
                ...
                Log.i("Tester", "onActivityResult: success");
                ...
                object.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e == null){
                            ...
                            Toast.makeText(UserListActivity.this, "image not uploaded, please try again", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView noUsersTextView = findViewById(R.id.noUserTextView);
        ...
        userListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent go_FeedActivity = new Intent(getApplicationContext(), FeedActivity.class);
                go_FeedActivity.putExtra("username", userList.get(position));
                startActivity(go_FeedActivity);
            }
        });
